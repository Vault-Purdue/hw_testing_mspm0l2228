 ...
 * @brief Crypto Module - AES-256-GCM authenticated encryption
 * @date 2026
 *
 * Wrapper over the AESADV and TRNG drivers
 *
 * Designed for the file chunk layout:
 *   STATUS (4B) | File ID (2B) | Chunk Index (2B) | IV (12B) |
 *   Auth Tag (16B) | Payload Size (2B) | Reserved (2B) |
 *   Data Payload (88B)
 */
...
// Initialize the module. Call once on startup.
// Calls AESADV_init() to power up the AES hardware.
